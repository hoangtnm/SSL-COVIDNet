...
from models import MocoCOVIDNet


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument("--phase", default="train", choices=["pretrain", "finetuning"], help="")
    ...
    if args.phase == "pretrain":
        ...
        model = MocoCOVIDNet(feature_extractor, num_classes=3)
